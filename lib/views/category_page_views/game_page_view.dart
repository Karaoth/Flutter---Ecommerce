          ...
          children: [
            ...
            StreamBuilder<List<Products>>(
              ...
              builder: (context, asyncSnapshot) {
                ...
                List<Products>? gameList = productDataList
                    ?.where((products) => products.type.contains('game'))
                    .toList();

                print('laptop liste uzunlugu: ${gameList?.length}');
                          ...
                          children: [
                            ...
                            Flexible(
                              child: ListView.builder(
                                itemCount: isFiltered == false ? gameList?.length : filteredList?.length,
                                itemBuilder: (context, index) {
                                  /// return Card yorum satırına aldığım yerde ki kodların
                                  /// yerine deneme amaçlı yazdım.
                                  List<Products>? newList = isFiltered == false ? gameList : filteredList;
                                  return Card(
